...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Cursor getTask(String userId){
        ...
        Cursor c=sqLiteDatabase.rawQuery("select * from task where user_id=? order by priority_id ",new String[]{userId});
